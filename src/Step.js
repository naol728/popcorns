...
Starrating.propType={
  ...
  onsetrating:propType.func.isRequired,
}
export default function Starrating({
  ...
  const textstyle={
    ...
    return <div style={constainerstyle} className={className}>
...
function Star({onRate,full,onHoverIn,onHoverOut,size,color}){
  const starstyle={
    ...
    return <span 
     role="button"
    style={starstyle} onClick={onRate} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}> 
   { full ? <svg
